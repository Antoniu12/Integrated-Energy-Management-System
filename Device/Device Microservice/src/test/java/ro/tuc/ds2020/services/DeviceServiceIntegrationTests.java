...
//        DeviceDetailsDTO p = new DeviceDetailsDTO("Telefon", "Somewhere Else street", 22);
//        UUID insertedID = deviceService.insert(p);
//
//        DeviceDTO insertedPerson = new DeviceDTO(insertedID, p.getDescription(), p.getEnergyConsumption());
//        DeviceDTO fetchedPerson = deviceService.findDeviceById(insertedID);
//
