...
public class PersonServiceIntegrationTests extends Ds2020TestConfig {
    ...
    public void testInsertCorrectWithGetById() {
        PersonDetailsDTO p = new PersonDetailsDTO("John","test", "Somewhere Else street", 22, "client");
        UUID insertedID = personService.insert(p);

        PersonDTO insertedPerson = new PersonDTO(insertedID, p.getName(), p.getPassword(),p.getAddress(), p.getAge(), p.getRole());
